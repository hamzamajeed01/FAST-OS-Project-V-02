					...
					for (int i = 0; i < tot; i++)
					{
						...
						if (i != tot - 1)
						{
							for (int j = 0; j < 64; j++)
							{
								...
								cout << "assigning the actual frame for pages " << j << "\tframe is: " << r1.frames[r1.frames[temp.val.table].page[i]].page[j] << endl;
								...
								for (int k = 0; k < v1; k++)
								{
									...
									r1.frames[r1.frames[r1.frames[temp.val.table].page[i]].page[j]].pno = j;
